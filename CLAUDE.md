...
**抽象度と、前提にしている知識の高さで決める。** 読んでいて躓く場所を上に置く。
...
| 中級 | 具体的で、指すものが目に見える |
| 上級 | 仕組みや概念の説明が要る |
| 特級 | 抽象的、または専門知識を前提にする |

**土台かどうかで決めない。** 土台であっても抽象的なら上に置く。
指数関数的成長はすべての前提だが、数の伸びかたの直感が要るので特級。
半導体は物性の話なので、会社の話（TSMC・ASMLは中級）より上。

具体 → 抽象の順に上がる、と考えると迷わない。
会社や人の名前は低く、その中で起きている仕組みは高い。
