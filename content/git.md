...
ファイルの変更を全部記録しておき、いつでも過去の状態に戻れるようにするツールです。
...
このGitを作ったのは、基本ソフトLinuxの生みの親であるリーナス・トーバルズです。開発で使っていたツールが使えなくなり、自分たちのために数週間で作りました。その私物のツールが、いまや世界中の開発現場の標準になっています。
