...
const GROUPS = [
  ...
  { name: 'AIのことば', slugs: [
    ...
    'neural-network', 'reinforcement-learning', 'parameter', 'training', 'training-data', 'dataset', 'annotation',
    ...
    'system-prompt', 'guardrail', 'alignment', 'subagent', 'ai-native', 'cognitive-offloading', 'domain-knowledge', 'benchmark', 'ai-drug-discovery',
...
<!-- data-nosnippet: 検索結果の説明文にこの定型文が抜かれないようにする。
     Google は団体名で検索されるとフッターの「〜のことばの辞典です」を説明文に使い、
     meta description（ひとことで）を捨てていた（2026/9/7 に確認） -->
